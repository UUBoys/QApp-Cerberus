...
/**
 * @generated from message com.qapp.auth.RegisterRequest
 */
export class RegisterRequest extends Message<RegisterRequest> {
  ...
  static readonly typeName = "com.qapp.auth.RegisterRequest";
...
/**
 * @generated from message com.qapp.auth.RegisterResponse
 */
export class RegisterResponse extends Message<RegisterResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.qapp.auth.RegisterResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message com.qapp.auth.LoginRequest
 */
export class LoginRequest extends Message<LoginRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.qapp.auth.LoginRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "email", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message com.qapp.auth.LoginResponse
 */
export class LoginResponse extends Message<LoginResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.qapp.auth.LoginResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message com.qapp.auth.GoogleLoginRequest
 */
export class GoogleLoginRequest extends Message<GoogleLoginRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "com.qapp.auth.GoogleLoginRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
